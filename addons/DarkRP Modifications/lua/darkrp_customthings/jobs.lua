...
TEAM_OFFICER = DarkRP.createJob( "Police Officer", {
	...
	weapons = { "arc9_fas_g20", "weapon_metal_detector", "weapon_gauto_spikestrip", "st_police_cuffs", "policebadge", "stungun", "arrest_stick", "unarrest_stick", "darkrp_speeder", "arc9_fas_mp5" },
	command = "officer",
	max = 6,
	salary = 75,
	admin = 0,
...
TEAM_POLICEBOSS = DarkRP.createJob( "Police Chief", {
	...
	weapons = { "arc9_fas_ragingbull", "weapon_metal_detector", "policebadge", "stungun", "st_police_cuffs", "weapon_gauto_spikestrip", "arrest_stick", "unarrest_stick", "darkrp_speeder", "arc9_fas_mp5" },
	command = "chief",
	max = 1,
	salary = 100,
	admin = 0,
...
TEAM_DETECTIVE = DarkRP.createJob( "Detective", {
	...
	weapons = { "arc9_fas_ragingbull", "weapon_metal_detector", "st_elastic_cuffs", "lockpick" },
	command = "detective",
	max = 2,
	salary = 25,
	admin = 0,
...
TEAM_UNDERCOVER = DarkRP.createJob( "Undercover Officer", {
	...
	weapons = { "arc9_fas_p226", "weapon_metal_detector", "policebadge", "stungun", "st_police_cuffs", "arrest_stick", "unarrest_stick", "weapon_agent" },
	command = "agent",
	max = 4,
	salary = 75,
	admin = 0,
